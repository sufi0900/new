...
export const ProductDetails = ({ product }: ProductDetailsProps) => {
  const portableTextComponents = {
    block: {
      ...
      h3: ({ children }) => <h3 className="...">{children}</h3>, // add Tailwind classes as needed
      // Continue mapping other styles...
    },
    list: {
      bullet: ({ children }) => (
    ...
    listItem: {
      ...
      number: ({ children }) => <li className="...">{children}</li>, // add Tailwind classes as needed
    },
    marks: {
      strong: ({ children }) => (
        <strong className="text-primary dark:text-white">{children}</strong>
      ),
      em: ({ children }) => <em>{children}</em>, // Style as needed
      // You can add styling for other marks like links or underline here
    },
    types: {
      // If you had custom types like images or embedded links, you would customize them here
      image: ({ value }) => (
      ...
      // Continue with other types like code blocks if you have any...
    },
  };
  return (
    <>
          ...
          <div className="relative z-20 mb-[60px] h-[300px] overflow-hidden rounded md:h-[400px] lg:h-[500px]">
            <div className="group relative">
              <Image
                ...
                layout="responsive"
                objectFit="cover"
                className="h-full w-full object-cover object-center transition-opacity duration-300 ease-in-out group-hover:bg-sky-500  group-hover:opacity-90"
              />
              {/* Overlay with transparency */}

              {/* Visit AI Tool button */}
              <div className="absolute inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50 transition-colors duration-300 ease-in-out  group-hover:bg-indigo-800 group-hover:bg-opacity-70">
                <Link href="/visit-ai-tool">
                  <p className="rounded-lg bg-blue-500 px-6 py-3 text-lg font-semibold text-white transition duration-300 ease-in-out hover:bg-blue-600">
                    Visit This AI Tool
                  </p>
                </Link>
              </div>
              ...
              <div className="mb-10 mt-12 rounded-sm bg-white p-6 shadow-three dark:bg-gray-dark dark:shadow-none lg:mt-0">
                <div className="flex items-center justify-between">
                  <input
                    ...
                    className="dark:text-body-color-dark mr-4 w-full rounded-sm border border-stroke bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
                  />
                  <button
