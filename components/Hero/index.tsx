          ...
          <div className="w-full lg:w-1/2">
            <div className="mb-12 max-w-md">
              ...
              <p className="dark:text-body-color-dark mb-8 text-base leading-relaxed text-body-color sm:text-lg md:text-xl">
                Discover the best AI image generators and unleash your
                creativity with prompts. Explore our curated list of free tools.
              </p>
              <div className="flex flex-col space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                <Link href="/pro-version">
                  <p className="rounded-sm bg-primary px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80">
                    🔥 Get Pro
                  </p>
                </Link>
                <Link href="/github-repo">
                  <p className="rounded-sm bg-black px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-black/90 dark:bg-white/10 dark:text-white dark:hover:bg-white/5">
                    Star on GitHub
                  </p>
                </Link>
              </div>
